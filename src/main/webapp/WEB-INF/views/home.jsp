...
<body>
	...
	<table style="width: 100%;">
		<tr>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/test/login">login测试页面</a></td>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/test/register">register测试页面</a></td>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/test/json/init">json测试页面</a></td>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/webflow/init">webflow测试页面</a></td>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/mybatis/init">mybatis测试页面</a></td>
		</tr>
		<tr>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/security/init">security测试页面</a></td>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/ehcache/init">ehcache测试页面</a></td>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/lottery/init">抽奖测试页面</a></td>
			<td style="width: 20%;"><a href="<%=request.getContextPath()%>/jsstudy/init">js学习页面</a></td>
